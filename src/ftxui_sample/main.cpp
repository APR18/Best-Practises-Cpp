...
// configuration step. It creates a namespace called `Best_Practises_C_`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Best_Practises_C_::cmake::project_name, Best_Practises_C_::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", Best_Practises_C_::cmake::project_version);
      return EXIT_SUCCESS;
    }
